...
const CartInfo = () => {
  ...
  return (
    <div className="px-4 py-2">
      ...
      <div className="mt-4 overflow-y-scroll scrollbar-none h-95" ref={scrollRef}>
        {
          cartData.length === 0 ? (
            <p className='text-[#ababab] text-sm flex justify-center items-center h-95'>Your Cart is empty. Start adding Items!</p>
          ) : cartData.map((item) => {
            return (
              <div className="bg-[#1f1f1f] rounded-lg px-4 py-4 mb-2">
                <div className="flex items-center justify-between">
                  <h1 className="text-[#ababab] font-semibold tracking-wide text-base">{item.name}</h1>
