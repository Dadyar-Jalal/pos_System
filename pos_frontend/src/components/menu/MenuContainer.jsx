            ...
            <div className="grid grid-cols-4 gap-4 px-10 py-4 w-full">
                {
                    menus.map((menu) => {
                        return (
                            <div key={menu.id} className="flex flex-col items-start justify-between p-4
                  rounded-lg h-25 cursor-pointer"
            ...
            <div className="grid grid-cols-4 gap-4 px-10 py-4 w-full">
                {
                    selected.items.map((item) => {
                        return (
                            ...
                            rounded-lg h-31.25 cursor-pointer hover:bg-[#2a2a2a] bg-[#1a1a1a]">
                                ...
                                <div className="flex items-center justify-between w-full">
                                    ...
                                    bg-[#1f1f1f] px-4 py-3 rounded-lg gap-6">
                                        <button
                                            onClick={()=> decrement(item.id)} 
                                            className="text-yellow-500
                                         hover:text-yellow-700 text-2xl">
                                            &minus;
                                        </button>
